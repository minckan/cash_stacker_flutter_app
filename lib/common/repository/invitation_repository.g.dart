...
class _InvitationRepository implements InvitationRepository {
  ...
  Future<List<Invitation>> getAllInvitations(
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<Invitation>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<Invitation> createInvitation({
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<Invitation>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = Invitation.fromJson(_result.data!);
    return value;
  }
