...
class InvitationApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [InvitationCreationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InvitationCreationResponse>> createInvitation({
    required String workspaceId,
    required CreateInvitationReq createInvitationReq,
    ...
    try {
      const type = FullType(CreateInvitationReq);
      bodyData =
          _serializers.serialize(createInvitationReq, specifiedType: type);
    ...
    InvitationCreationResponse? responseData;
    ...
    try {
      ...
      responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(InvitationCreationResponse),
            ) as InvitationCreationResponse;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<InvitationCreationResponse>(
      data: responseData,
