...
class WorkspaceApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CreateWorkspaceRes] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateWorkspaceRes>> createWorkspace({
    required CreateWorkspaceReq createWorkspaceReq,
    ...
    try {
      const type = FullType(CreateWorkspaceReq);
      bodyData =
          _serializers.serialize(createWorkspaceReq, specifiedType: type);
    ...
    CreateWorkspaceRes? responseData;
    ...
    try {
      ...
      responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CreateWorkspaceRes),
            ) as CreateWorkspaceRes;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<CreateWorkspaceRes>(
      data: responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Workspace>>> getAllWorkspace({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Workspace>> getWorkspaceById({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
