...
class FinancialCategoryApi {
  ...
  Future<Response<void>> workspaceIdFinanceCategoryIdDelete({
    ...
    final _path = r'/{workspaceId}/finance/category/{id}'
        .replaceAll(
            '{' r'workspaceId' '}',
  ...
  Future<Response<TransactionCategory>> workspaceIdFinanceCategoryIdPut({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(workspaceIdFinanceCategoryIdPutRequest,
          specifiedType: _type);
  ...
  Future<Response<TransactionCategory>> workspaceIdFinanceCategoryPost({
    ...
    final _path = r'/{workspaceId}/finance/category'.replaceAll(
        '{' r'workspaceId' '}',
    ...
    try {
      ...
      _bodyData = _serializers.serialize(workspaceIdFinanceCategoryPostRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<BuiltList<TransactionCategory>>>
    ...
    final _path = r'/{workspaceId}/finance/category/{type}'
        .replaceAll(
            '{' r'workspaceId' '}',
            encodeQueryParameter(
                    _serializers, workspaceId, const FullType(String))
