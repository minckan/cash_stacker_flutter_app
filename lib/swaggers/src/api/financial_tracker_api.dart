...
class FinancialTrackerApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [WorkspaceIdFinanceMonthlyMonthKeyGet200Response] as data
  ...
  Future<Response<WorkspaceIdFinanceMonthlyMonthKeyGet200Response>>
    ...
    final _path = r'/{workspaceId}/finance/daily/{dateKey}'
        .replaceAll(
            '{' r'workspaceId' '}',
    ...
    WorkspaceIdFinanceMonthlyMonthKeyGet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
            ...
            ) as WorkspaceIdFinanceMonthlyMonthKeyGet200Response;
  ...
  Future<Response<void>> workspaceIdFinanceIdDelete({
    ...
    final _path = r'/{workspaceId}/finance/{id}'
        .replaceAll(
            '{' r'workspaceId' '}',
            encodeQueryParameter(
                    _serializers, workspaceId, const FullType(String))
  ...
  Future<Response<Transaction>> workspaceIdFinanceIdPut({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(workspaceIdFinanceIdPutRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<WorkspaceIdFinanceMonthlyMonthKeyGet200Response>>
    ...
    final _path = r'/{workspaceId}/finance/monthly/{monthKey}'
        .replaceAll(
            '{' r'workspaceId' '}',
            encodeQueryParameter(
                    _serializers, workspaceId, const FullType(String))
  ...
  Future<Response<Transaction>> workspaceIdFinancePost({
    ...
    final _path = r'/{workspaceId}/finance'.replaceAll(
        '{' r'workspaceId' '}',
    ...
    try {
      ...
      _bodyData = _serializers.serialize(workspaceIdFinancePostRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
