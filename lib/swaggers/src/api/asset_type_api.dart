...
class AssetTypeApi {
  ...
  const AssetTypeApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<AssetType>>> workspaceIdAssetTypeGet({
    ...
    final _path = r'/{workspaceId}/asset/type'.replaceAll(
        '{' r'workspaceId' '}',
  ...
  Future<Response<void>> workspaceIdAssetTypeIdDelete({
    ...
    final _path = r'/{workspaceId}/asset/type/{id}'
        .replaceAll(
            '{' r'workspaceId' '}',
  ...
  Future<Response<AssetType>> workspaceIdAssetTypeIdPut({
    ...
    try {
      const _type = FullType(WorkspaceIdAssetTypeIdPutRequest);
      _bodyData = _serializers.serialize(workspaceIdAssetTypeIdPutRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  Future<Response<AssetType>> workspaceIdAssetTypePost({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(workspaceIdAssetTypePostRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
