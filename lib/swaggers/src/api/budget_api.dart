...
class BudgetApi {
  ...
  Future<Response<Budget>> createBudget({
    ...
    required CreateBudgetReq createBudgetReq,
    ...
    try {
      const type = FullType(CreateBudgetReq);
      bodyData = _serializers.serialize(createBudgetReq, specifiedType: type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetActiveBudgetRes] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetActiveBudgetRes>> getActiveBudget({
    ...
    GetActiveBudgetRes? responseData;
    ...
    try {
      ...
      responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetActiveBudgetRes),
            ) as GetActiveBudgetRes;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: response.requestOptions,
        response: response,
    ...
    return Response<GetActiveBudgetRes>(
      data: responseData,
      headers: response.headers,
      isRedirect: response.isRedirect,
      requestOptions: response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Budget>>> getAllBudgets({
    required String workspaceId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<Budget>> updateBudget({
    required String workspaceId,
    required int id,
    required UpdateBudgetRequest updateBudgetRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const type = FullType(UpdateBudgetRequest);
      bodyData =
          _serializers.serialize(updateBudgetRequest, specifiedType: type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: options.compose(
          _dio.options,
